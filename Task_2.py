...
def print_operation_table(a,b):
    function_lambda = lambda a, b: a * b
    num_rows = 6
    num_columns = 6
    for i in range(1, num_rows+1):
        for j in range(i, i*num_columns+1, i):
            print(j, end=' ')
        print()
    return function_lambda(a,b)
rows = 6
columns = 6
x = int(input('Введите номер строки элемента: '))
y = int(input('Введите номер столбца элемента: '))
# operation = lambda a, b: a * b
# print(operation(x,y))
p = print_operation_table(x, y)
print(p)
